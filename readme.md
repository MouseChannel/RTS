...
make it Multi-client synchronization
### 🫱 [RVO2 Collision Avoidance ](https://github.com/MouseChannel/MCRVO)
rewriten by Unity ECS Framework
### 🫱 [Large map with multi-level pathfinding](https://github.com/MouseChannel/Hierarchical-Pathfind)
Hierarchy A-Star path finding
### 🫱 Texture-Base Shader Animation
shader vertex animation to rendered in ECS framework
