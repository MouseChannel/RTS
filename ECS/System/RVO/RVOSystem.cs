...
namespace RVO
{
    ...
    public partial class RVOSystem : WorkSystem
    {
        ...
        private NativeList<Agent> agents_ = new NativeList<Agent>(Allocator.Persistent);
        private NativeList<AgentTreeNode> agentTree_ = new NativeList<AgentTreeNode>(Allocator.Persistent);
        ...
        public override void Work()
        {
            ...
            // NativeList<Agent> agents_ = new NativeList<Agent>(Allocator.TempJob);
            // NativeList<AgentTreeNode> agentTree_ = new NativeList<AgentTreeNode>(Allocator.TempJob);
            agents_.Clear();
            agentTree_.Clear();
