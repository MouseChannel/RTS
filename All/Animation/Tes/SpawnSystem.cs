...
public partial class SpawnSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F1))
        {
            ...
            // Entities.ForEach((in RenderMesh renderMesh) =>
            // {
    ...
    private void SpawnUnit()
    {
        ...
        // beSpawnedUnitSpriptableObject.InitUnitComponent(EntityManager, beSpawnedEntity);
    ...
    //     }
    //     BlobAssetUtil.animationBlobStore.TryGet<AnimationBlobElement>(new Unity.Entities.Hash128(anim.animationName), out var reference);
